...
class Login_Manager {
	...
	function check_login($required_group = -1)
	{
		...
		if($required_group > 0)
		{
			...
			{
				show_error('You do not have access to this section.<br /><a href="'.site_url("admin/auth/logout").'">logout</a>');
			}
		}
	}
	...
	{
		// attempt the login
		$success = $user->login($this->login_type);
		if($success)
		{
