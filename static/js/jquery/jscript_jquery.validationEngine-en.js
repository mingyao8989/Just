	...
	$.validationEngineLanguage = {
		newLang : function() {
			$.validationEngineLanguage.allRules = {
				...
				"length" : {
					"regex" : "none",
					"alertText" : "* The length is incorrect, it must be between "
				},
				"digitInBetween" : {
					"regex" : "none",
					"alertText" : "* Please enter a valid integer. The value must be between "
				},
				"past" : {
					"regex" : "none",
				...
				"equals" : {
					"regex" : "none",
					"alertText" : "* This field is different from "
				},
				"phone" : {
				...
				"validateMultiSelectbox" : {
					"alertText" : "* Please select the options"
				}
			};
